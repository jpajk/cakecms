...
class PagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'contents' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'user_id' => 1,
                'created' => '2018-07-25 15:17:10',
                'updated' => '2018-07-25 15:17:10'
            ],
        ];
        parent::init();
    }
